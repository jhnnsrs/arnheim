...
class BioMeta(models.Model):
    ...
    channellist = models.CharField(max_length=2000, blank=True,null=True)
    ...
    spacial_units = models.CharField(max_length=30, blank=True,null=True)
    temporal_units = models.CharField(max_length=30, blank=True,null=True)
